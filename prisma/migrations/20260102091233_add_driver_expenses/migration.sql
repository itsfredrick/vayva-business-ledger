...
INSERT INTO "new_DriverDay" ("cashReceivedNaira", "dayId", "driverCommissionNaira", "driverProfileId", "expectedNaira", "finalReturnBags", "id", "motorBoyCommissionNaira", "motorBoyName", "normalBags", "notes", "outstandingEndNaira", "outstandingStartNaira", "receivedLoggedNaira", "supplierBags", "totalLoadedBags", "totalSoldBags", "totalTrips") SELECT "cashReceivedNaira", "dayId", "driverCommissionNaira", "driverProfileId", "expectedNaira", "finalReturnBags", "id", "motorBoyCommissionNaira", "motorBoyName", "normalBags", "notes", "outstandingEndNaira", "outstandingStartNaira", "receivedLoggedNaira", "supplierBags", "totalLoadedBags", "totalSoldBags", "totalTrips" FROM "DriverDay";
